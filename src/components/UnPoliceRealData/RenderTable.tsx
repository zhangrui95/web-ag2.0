  ...
  render() {
    ...
    let detail = (
      ...
      >
        <Col span={8}>
          接警人：
          {this.state.shareRecord && this.state.shareRecord.jjr ? this.state.shareRecord.jjr : ''}
        </Col>
        <Col span={8}>
          管辖单位：
          <Tooltip
            title={
              ...
              this.state.shareRecord.jjdw_mc &&
              this.state.shareRecord.jjdw_mc.length > 12
                ? this.state.shareRecord.jjdw_mc
                : null
            }
          >
            {this.state.shareRecord && this.state.shareRecord.jjdw_mc
              ? this.state.shareRecord.jjdw_mc.length > 12
                ? this.state.shareRecord.jjdw_mc.substring(0, 12) + '...'
                : this.state.shareRecord.jjdw_mc
              : ''}
          </Tooltip>
        </Col>
        <Col span={8}>
          ...
          <Tooltip
            title={
              this.state.shareRecord &&
              this.state.shareRecord.jjnr &&
              this.state.shareRecord.jjnr.length > 12
                ? this.state.shareRecord.jjnr
                : null
            }
          >
            {this.state.shareRecord && this.state.shareRecord.jjnr
              ? this.state.shareRecord.jjnr.length > 12
                ? this.state.shareRecord.jjnr.substring(0, 12) + '...'
                : this.state.shareRecord.jjnr
              : ''}
          </Tooltip>
        </Col>
        <Col span={8}>
          处警人：
          {this.state.shareRecord && this.state.shareRecord.cjr ? this.state.shareRecord.cjr : ''}
        </Col>
        <Col span={8}>
          处警单位：
          <Tooltip
            title={
              this.state.shareRecord &&
              this.state.shareRecord.cjdw_mc &&
              this.state.shareRecord.cjdw_mc.length > 12
                ? this.state.shareRecord.cjdw_mc
                : null
            }
          >
            {this.state.shareRecord && this.state.shareRecord.cjdw_mc
              ? this.state.shareRecord.cjdw_mc.length > 12
                ? this.state.shareRecord.cjdw_mc.substring(0, 12) + '...'
                : this.state.shareRecord.cjdw_mc
              : ''}
          </Tooltip>
        </Col>
        <Col span={8}>
          ...
          <Tooltip
            title={
              this.state.shareRecord &&
              this.state.shareRecord.cjqk &&
              this.state.shareRecord.cjqk.length > 12
                ? this.state.shareRecord.cjqk
                : null
            }
          >
            {this.state.shareRecord && this.state.shareRecord.cjqk
              ? this.state.shareRecord.cjqk.length > 12
                ? this.state.shareRecord.cjqk.substring(0, 12) + '...'
                : this.state.shareRecord.cjqk
              : ''}
          </Tooltip>
        </Col>
