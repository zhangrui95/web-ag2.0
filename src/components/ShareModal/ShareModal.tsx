            ...
            if (!values.sharePerson || values.sharePerson.length === 0) {
                ...
                this.props.dispatch({
                    ...
                    payload: {
                        ...
                        fx_xm: name.toString(),
                        agid: this.props.tzlx === 'jqwt' || this.props.tzlx === 'jzwt' ? this.props.shareItem.wtid : this.props.shareItem.id,
                        fxjy: values.shareSuggest,
                        lx: this.props.lx,
                        sx: this.props.sx,
                        type: 2,
                        tzlx: this.props.tzlx,
                        wtid: this.props.shareItem.wtid,
                        ajbh: this.props.shareItem.ajbh,
                        system_id: this.props.tzlx === 'jqwt' ? this.props.shareItem.id : this.props.tzlx === 'jzwt' || this.props.tzlx === 'jzxx' ? this.props.shareItem.dossier_id : this.props.tzlx === 'baqwt' ? this.props.shareItem.baq_id : this.props.shareItem.system_id,
                    },
                    callback: (res) => {
                        if (!res.error) {
