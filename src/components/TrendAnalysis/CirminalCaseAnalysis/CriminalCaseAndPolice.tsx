        ...
        const acceptCaseColumns = [
            {
                ...
                render: (text) => {
                    if (text === '同比增幅（起）') {
                        return <span>同比增幅（起）<Tooltip title="同比增幅=本期数-同期数"><Icon type="info-circle-o" theme={this.props.global && this.props.global.dark ? "twoTone" : "outlined"} twoToneColor={this.props.global && this.props.global.dark ? "#aaa" :''} /></Tooltip></span>;
                    } else if (text === '同比增幅（%）') {
                        return <span>同比增幅（%）<Tooltip title="同比增涨率=（本期数-同期数）/同期数×100%"><Icon type="info-circle-o" theme={this.props.global && this.props.global.dark ? "twoTone" : "outlined"} twoToneColor={this.props.global && this.props.global.dark ? "#aaa" :''} /></Tooltip></span>;
                    } else if (text === '环比增幅（起）') {
                        return <span>环比增幅（起）<Tooltip title="环比增幅=本期数-上期数"><Icon type="info-circle-o" theme={this.props.global && this.props.global.dark ? "twoTone" : "outlined"} twoToneColor={this.props.global && this.props.global.dark ? "#aaa" :''} /></Tooltip></span>;
                    } else if (text === '环比增幅（%）') {
                        return <span>环比增幅（%）<Tooltip title="环比增涨率=（本期数-上期数）/上期数×100%"><Icon type="info-circle-o" theme={this.props.global && this.props.global.dark ? "twoTone" : "outlined"} twoToneColor={this.props.global && this.props.global.dark ? "#aaa" :''} /></Tooltip></span>;
                    } else {
                        return text;
                    }
                },
