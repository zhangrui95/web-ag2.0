    ...
    setChartsAndTableData = (caseType) => {
        ...
        if (typeData) {
            lineData = [{
                ...
                cursor: 'default',
                data: [
                    typeData.now.count5 || 0,
                    typeData.now.count10 || 0,
                    typeData.now.count15 || 0,
                ...
                cursor: 'default',
                data: [
                    typeData.tongbi.count5 || 0,
                    typeData.tongbi.count10 || 0,
                    typeData.tongbi.count15 || 0,
                    typeData.tongbi.count20 || 0,
                    typeData.tongbi.count25 || 0,
                    typeData.tongbi.count30 || 0,
                ],
                itemStyle: {
                    color: '#DCCA23',
                },
                ...
                cursor: 'default',
                data: [
                    typeData.huanbi.count5 || 0,
                    typeData.huanbi.count10 || 0,
                    typeData.huanbi.count15 || 0,
                    typeData.huanbi.count20 || 0,
                    typeData.huanbi.count25 || 0,
                    typeData.huanbi.count30 || 0,
                ],
                itemStyle: {
                    color: '#31BD74',
                },
