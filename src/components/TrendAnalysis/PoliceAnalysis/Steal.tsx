            ...
            columns = [
                {
                    ...
                    render: (text) => {
                        if (text === '同比增幅（起）') {
                            return <span>同比增幅（起）<Tooltip title="同比增幅=本期数-同期数"><Icon
                                type="info-circle-o"/></Tooltip></span>;
                        } else if (text === '同比增幅（%）') {
                            return <span>同比增幅（%）<Tooltip title="同比增涨率=（本期数-同期数）/同期数×100%"><Icon
                                type="info-circle-o"/></Tooltip></span>;
                        } else if (text === '环比增幅（起）') {
                            return <span>环比增幅（起）<Tooltip title="环比增幅=本期数-上期数"><Icon
                                type="info-circle-o"/></Tooltip></span>;
                        } else if (text === '环比增幅（%）') {
            ...
            <Spin spinning={loadingData} size="large" tip="数据加载中...">
                <div className={styles.analysis}>
                    ...
                    <Row>
                        <Col lg={12} md={24}>
                            <div
                                className={"stealBar" + ' ' + (this.props.global && this.props.global.dark ? '' : styles.lightChartBox)}
                                style={{height: 300}}/>
                        </Col>
                        <Col lg={12} md={24}>
                            <div
                                className={"stealAllType" + ' ' + (this.props.global && this.props.global.dark ? '' : styles.lightChartBox)}
                                style={{height: 300}}/>
                        </Col>
                    </Row>
