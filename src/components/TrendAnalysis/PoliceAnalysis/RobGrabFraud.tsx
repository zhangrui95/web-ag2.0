      ...
      callback: data => {
        if (data) {
          ...
          if (zhapian) {
            ...
            xData = [selectedDateStr, yearOnYearDateStr, monthOnMonthDateStr];
            barData = [
              {
                name: selectedDateStr,
  ...
  render() {
    ...
    let className =
      this.props.global && this.props.global.dark
        ? styles.analysis
        : styles.analysis + ' ' + styles.lightBox;
    return (
      <Spin spinning={loadingData} size="large" tip="数据加载中...">
        <div className={className}>
          ...
          <Table
            columns={columns}
            dataSource={liangqiangTableData}
            bordered
          ...
          <div
            className={
              this.props.global && this.props.global.dark ? styles.borderTop : styles.borderTops
            }
          ></div>
          ...
          <Row className={styles.fraudArea}>
            <Col lg={12} md={24}>
              <div
                id="fraudBar"
                style={{ height: 420, margin: '25px 0 0 26px' }}
