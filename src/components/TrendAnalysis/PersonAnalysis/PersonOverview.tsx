                        ...
                        dealBarData = [
                          {
                            ...
                            data: [
                                { name: '提请逮捕人数', value: tqdb.nowtime || 0, itemStyle: { color: '#3AA0FF' },code:12 },
                                { name: '批准逮捕人数', value: pzdb.nowtime || 0, itemStyle: { color: '#3AA0FF' },code:17 },
                                { name: '移送起诉人数', value: ysqs.nowtime || 0, itemStyle: { color: '#3AA0FF' },code:11 },
                            ],
                        },
                          {
                            ...
                            data: [
                                { name: '提请逮捕人数', value: tqdb.lastyear || 0, itemStyle: { color: '#DCCA23' },code:12 },
                                { name: '批准逮捕人数', value: pzdb.lastyear || 0, itemStyle: { color: '#DCCA23' },code:17 },
                                { name: '移送起诉人数', value: ysqs.lastyear || 0, itemStyle: { color: '#DCCA23' },code:11 },
                            ],
                        },
                          {
                            ...
                            data: [
                                { name: '提请逮捕人数', value: tqdb.lastmonth || 0, itemStyle: { color: '#31BD74' },code:12 },
                                { name: '批准逮捕人数', value: pzdb.lastmonth || 0, itemStyle: { color: '#31BD74' },code:17 },
                                { name: '移送起诉人数', value: ysqs.lastmonth || 0, itemStyle: { color: '#31BD74' },code:11 },
                            ],
                        }];
                        dealSuspectTypeTableData = [
                            {
                        ...
                        barData = [
                          {
                            ...
                            data: [
                                { name: '犯罪嫌疑人', value: fz.nowtime || 0, itemStyle: { color: '#3AA0FF' },code:'01' },
                                { name: '违法行为人', value: wf.nowtime || 0, itemStyle: { color: '#3AA0FF' },code:'02' },
                            ],
                          },
                          {
                            name: yearOnYearDateStr,
                            ...
                            data: [
                                { name: '犯罪嫌疑人', value: fz.lastyear || 0, itemStyle: { color: '#DCCA23' },code:'01' },
                                { name: '违法行为人', value: wf.lastyear || 0, itemStyle: { color: '#DCCA23' },code:'02' },
                            ],
                          },
                          {
                            name: monthOnMonthDateStr,
                            ...
                            data: [
                                { name: '犯罪嫌疑人', value: fz.lastmonth || 0, itemStyle: { color: '#31BD74' },code:'01' },
    ...
    showDealSuspectTypeBar = (xData,barData) => {
        ...
        if(window.configUrl.is_area==='2'){
          suspectCountBar.on('click',function(param){
            const { departorgan } = that.props;
            const { selectedDateStr,selectedDate, yearOnYearDateStr,yearOnYearDate, monthOnMonthDateStr,monthOnMonthDate } = that.props;
            that.props.dispatch(routerRedux.push({
              pathname: '/allDocuments/personalDocTransfer/personalDoc',
              queryChange: {
                departmentId: departorgan&&departorgan.id?departorgan.id:'',
            ...
            <Spin spinning={loadingData} size="large" tip="数据加载中...">
                <div className={styles.analysis}>
                    ...
                    <Row className={styles.fraudArea}>
                        ...
                        <Col lg={12} md={24}>
                            <Table columns={suspectCountColumns} dataSource={suspectCountTableData} bordered
                                   className={styles.tableArea} pagination={false}/>

                        </Col>
                    </Row>
                    <h2 className={styles.areaTitle}></h2>
                    <div id="dealSuspectTypeBar" style={{ height: 300 }}/>
                    <Table columns={columns} dataSource={dealSuspectTypeTableData} className={styles.fraudTable}
