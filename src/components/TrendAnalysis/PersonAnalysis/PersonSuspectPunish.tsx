            ...
            barData = [
              {
                ...
                data: [
                  ...
                  {
                    name: '监视居住',
                    value: jsjz.nowtime || 0,
                    itemStyle: { color: '#3AA0FF' },
                    code: '4',
                  },
                  {
                    name: '取保候审',
                    value: qbhs.nowtime || 0,
                    itemStyle: { color: '#3AA0FF' },
                    code: '3',
                  },
                ],
              },
              {
                ...
                data: [
                  ...
                  {
                    name: '监视居住',
                    value: jsjz.lastyear || 0,
                    itemStyle: { color: '#DCCA23' },
                    code: '4',
                  },
                  {
                    name: '取保候审',
                    value: qbhs.lastyear || 0,
                    itemStyle: { color: '#DCCA23' },
                    code: '3',
                  },
                ],
              },
              {
                ...
                data: [
                  {
                    name: '逮捕',
                    value: db.lastmonth || 0,
                    itemStyle: { color: '#31BD74' },
                    code: '22',
                  },
                  {
                    name: '拘传',
                    value: jc.lastmonth || 0,
                    itemStyle: { color: '#31BD74' },
                    code: '7',
                  },
                  {
                    name: '拘留',
                    value: jl.lastmonth || 0,
                    itemStyle: { color: '#31BD74' },
                    code: '1',
                  },
                  {
                    name: '监视居住',
                    value: jsjz.lastmonth || 0,
                    itemStyle: { color: '#31BD74' },
                    code: '4',
                  },
                  {
                    name: '取保候审',
                    value: qbhs.lastmonth || 0,
                    itemStyle: { color: '#31BD74' },
                    code: '3',
                  },
                ],
