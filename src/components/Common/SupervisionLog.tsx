          ...
          <div>
            ...
            >
              <Row style={{ margin: '16px 46px' }}>
                <Col md={8} sm={24}>
                  <div className={listStyles.Indexfrom} style={{top:0}}>问题类型：</div>
                  <div className={listStyles.Indextail} style={{ paddingLeft: 72 }}>
                    {detailData && detailData.wtlx ? detailData.wtlx : ''}
                  </div>
                </Col>
                <Col md={8} sm={24}>
                  <div className={listStyles.Indexfrom} style={{top:0}}>产生方式：</div>
                  <div className={listStyles.Indextail} style={{ paddingLeft: 72 }}>
                    {detailData && detailData.fxfs ? detailData.fxfs : ''}
                  </div>
                </Col>
                <Col md={8} sm={24}>
                  <div className={listStyles.Indexfrom} style={{top:0}}>责任人：</div>
              ...
              <Row style={{ margin: '16px 46px' }}>
                <Col md={24} sm={24}>
                  <div className={listStyles.Indexfrom} style={{top:0}}>责任单位：</div>
                  <div className={listStyles.Indextail} style={{ paddingLeft: 72 }}>
