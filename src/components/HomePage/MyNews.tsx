        ...
        return (
            ...
            >
                <Row style={{ marginBottom: '0' }}>
                    ...
                    <Col
                        span={this.props.datail.name && this.props.datail.name.length > 16 ? 16 : 8}>案件名称：{this.props.datail.name}</Col>
                    ...
                    <Col
                        span={this.props.datail.zrrDwmc && this.props.datail.zrrDwmc.length > 16 ? 16 : 8}>责任单位：{this.props.datail.zrrDwmc}</Col>
                </Row>
                <Row>
                    <Col span={24}>
                        <div className={styles.content}>反馈信息：</div>
                        <div className={styles.content} style={{ width: '700px' }}>{this.props.datail.content}</div>
                    </Col>
                </Row>
            </Modal>
        );
