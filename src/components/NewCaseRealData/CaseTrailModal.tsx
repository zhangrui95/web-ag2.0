                ...
                <div className={styles.TopPersonFiles}>
                    <Row>
                        ...
                        <Col md={17} sm={24} style={{paddingLeft: '12px'}}>
                            ...
                            <div style={{textAlign: 'left', padding: '5px 0'}}>性别：{text.sex}</div>
                            <div className={styles.CdCard}>证件号：{text.sfzh}</div>
                        </Col>
                    </Row>
                </div>
        ...
        if (ajzt) {
            if (ajzt === '受理') {
                                        ...
                                        <div>
                                            ...
                                            >
                                                {caseDetails.xyrList.map(text => (
                                                    <Step
                                                        title={this.extraBottomTitle(text, caseDetails)}
                                                        description={this.extraBottomDescription(
                                                            text,
                                                            caseDetails,
                                                        )} /*className={styles.stepStyles}*/
                                                    />
                                                ))}
                                            </Steps>
                                            {maxLength > 5 ? (
              ...
              <span className={styles.timeline}>
                ...
                return <div className={styles.noAccept}>案件处于未受理状态，暂无轨迹</div>;
            }
        } else {
        }
    }
    ...
    detail() {
        ...
        return (
            <div
                ...
                style={{paddingBottom: TrackPaddingBottom, paddingTop: TrackPaddingTop}}
            >
