/*
* XzCaseEnforcementDataView.js 行政案件数据展示
* author：jhm
* 20190326
* */
...
export default class XzCaseEnforcementDataView extends PureComponent {
    ...
    showXzCaseEchartRingPie = () => {
        ...
        xzCaseEchartRingPie.on('click', function(params) {
            ...
            that.props.changeToListPage({ ajzt: params.name && params.name === '受理' ? '201' : '206' }, dataTime);
        });
    };
    // 受结情况展示
    showXzCaseEchartLine = () => {
        ...
        xzCaseEchartLine.on('click', function(params) {
            ...
            that.props.changeToListPage({ ajzt: params.seriesName && params.seriesName === '受理' ? '201' : '206' }, dataTime);
        });
    };
