        ...
        let detail = (
            <Row style={{ width: '90%', margin: '0 38px 10px', lineHeight: '36px', color: 'rgba(0, 0, 0, 0.85)' }}>
                ...
                <Col span={12}>受理单位：<Tooltip
                    title={this.state.shareRecord && this.state.shareRecord.sldwName && this.state.shareRecord.sldwName.length > 20 ? this.state.shareRecord.sldwName : null}>{this.state.shareRecord && this.state.shareRecord.sldwName ? this.state.shareRecord.sldwName.length > 20 ? this.state.shareRecord.sldwName.substring(0, 20) + '...' : this.state.shareRecord.sldwName : ''}</Tooltip></Col>
                <Col
