    ...
    render() {
        ...
        let detail = (
            <Row style={{ width: '90%', margin: '0 38px 10px', lineHeight: '36px', color: 'rgba(0, 0, 0, 0.85)' }}>
                ...
                <Col
                    span={6}>物品种类：{this.state.shareRecord && this.state.shareRecord.wplx_mc ? this.state.shareRecord.wplx_mc : ''}</Col>
                <Col
                    span={6}>物品状态：{this.state.shareRecord && this.state.shareRecord.zt ? this.state.shareRecord.zt : ''}</Col>
