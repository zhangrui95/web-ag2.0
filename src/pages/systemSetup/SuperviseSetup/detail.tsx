...
class Detail extends Component {
        ...
        that.props.dispatch({
          ...
          callback: res => {
            if (!res.error) {
                ...
                let key = '/systemSetup/SuperviseSetup/Update' + id;
  ...
  render() {
    ...
    return (
      <div
        id={'boxSeperDetail'}
        className={this.props.SuperviseSetup.global.dark ? '' : styles.lightBox}
      >
        <Card
          className={stylescommon.statistics + ' ' + styles.detailBox}
          id={'formSeperDetail' + this.props.location.query.id}
        >
          <Form>
            <Row gutter={rowLayout} className={styles.formBoxBorder}>
              ...
              <Col span={8}>
                <FormItem label="监管点" {...modleLayoutjg} disabled={!disable}>
                  ...
                  <Tooltip title={this.state.NoticeNote}>
            ...
            <Row
              gutter={rowLayout}
              className={this.state.addjglx === '1' ? styles.formBox : styles.none}
            >
              <Row>
                <Col span={8}>
                  <FormItem
                  ...
                  <FormItem label="显示颜色" {...modleLayoutColor}>
                    ...
                    >
                      <div
                        ...
                        style={{ background: this.state.xsys3 }}
                      ></div>
                    </Dropdown>
                  </FormItem>
                </Col>
                ...
                <Col span={8}>
                  <FormItem label="显示颜色" {...modleLayoutColor}>
                    ...
                    >
                      <div
                        className={styles.boxColor}
                        style={{ background: this.state.xsys2 }}
                      ></div>
                    </Dropdown>
                  </FormItem>
                </Col>
                ...
                <Col span={8}>
                  <FormItem label="显示颜色" {...modleLayoutColor}>
                    ...
                    >
                      <div
                        className={styles.boxColor}
                        style={{ background: this.state.xsys1 }}
                      ></div>
                    </Dropdown>
                  </FormItem>
                </Col>
