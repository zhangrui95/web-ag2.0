                ...
                <Col {...colLayout}>
                  <FormItem label="预警类型" {...formItemLayout}>
                    {getFieldDecorator('yjlx', {
                      ...
                      <Select placeholder="请选择预警类型" style={{ width: '100%' }} getPopupContainer={() => document.getElementById('newslaxsajyjtableListForm')}>
                ...
                <Col {...colLayout}>
                  <FormItem label="预警级别" {...formItemLayout}>
                    {getFieldDecorator('yjjb', {
                      ...
                      <Select placeholder="请选择预警级别" style={{ width: '100%' }} getPopupContainer={() => document.getElementById('newslaxsajyjtableListForm')}>
                        <Option value="">全部</Option>
                        {YJJBStatusOptions}
                      </Select>,
                    )}
