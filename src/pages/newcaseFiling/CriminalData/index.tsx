...
import CaseDataView from '../../../components/CaseRealData/CaseEnforcementDataViewAll';
          ...
          <Col {...colLayout}>
            <FormItem label="案件状态" {...formItemLayout}>
              {getFieldDecorator('ajzt', {
                ...
                <Select placeholder="请选择案件状态" style={{ width: '100%' }} onChange={this.chooseStatus} getPopupContainer={() => document.getElementById('newslatableListForm')}>
            ...
            <FormItem label="专项类别" {...formItemLayout}>
              {getFieldDecorator('zxlb', {
                ...
                <Select placeholder="请选择专项类别" style={{ width: '100%' }}
                        onChange={this.specialCaseOnChange} getPopupContainer={() => document.getElementById('newslatableListForm')}>
                  <Option value="">全部</Option>
            ...
            <Col {...colLayout}>
              <FormItem label="强制措施" {...formItemLayout}>
                {getFieldDecorator('qzcslx', {})(
                  <Select placeholder="请选择强制措施" style={{width: '100%'}} mode={'multiple'} getPopupContainer={() => document.getElementById('newslatableListForm')}>
                    <Option value="">全部</Option>
