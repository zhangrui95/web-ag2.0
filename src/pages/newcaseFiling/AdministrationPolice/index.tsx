...
import UnXzCaseDataView from '../../../components/UnXzCaseRealData/UnXzCaseEnforcementDataViewAll';
          ...
          <Col {...colLayout}>
            <FormItem label="问题类型" {...formItemLayout}>
              {getFieldDecorator('wtlx', {
                ...
                <Select placeholder="请选择问题类型" style={{ width: '100%' }} getPopupContainer={() => document.getElementById('newslaxzajgjtableListForm')}>
          ...
          <Col {...colLayout}>
            <FormItem label="案件状态" {...formItemLayout}>
              {getFieldDecorator('ajzt', {
                ...
                <Select placeholder="请选择案件状态" style={{ width: '100%' }} getPopupContainer={() => document.getElementById('newslaxzajgjtableListForm')}>
                  <Option value="">全部</Option>
                  {XzCaseStatusOption}
                </Select>,
              )}
          ...
          <Col {...colLayout}>
            <FormItem label="产生方式" {...formItemLayout}>
              {getFieldDecorator('csfs', {
                ...
                <Select placeholder="请选择产生方式" style={{ width: '100%' }}  onChange={this.getCsfs} getPopupContainer={() => document.getElementById('newslaxzajgjtableListForm')}>
                  <Option value="">全部</Option>
