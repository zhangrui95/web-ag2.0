...
export default class itemDetail extends PureComponent {
                    ...
                    <Col md={8} sm={24}>
                        ...
                        {isDb && itemDetails && itemDetails.zrdwList && itemDetails.zrdwList.length > 0 ?
                            <Button type="primary" className={styles.TopMenu}
                                    onClick={() => this.onceSupervise(itemDetails, true, '涉案物品详情问题判定')}>问题判定</Button>
                            :
                            ''
                        }
                    </Col>
                                ...
                                itemDetails ?
                                    <span>
                                      ...
                                      <span className={liststyles.collect}
                                        ...
                                        <Tooltip title="分享"><img src={dark ? share : share1} style={{marginLeft: 12}}
                                                                 width={25} height={25}/></Tooltip>
    ...
    renderDetail() {
        ...
        let dark = this.props.global && this.props.global.dark;
        return (
            <div style={{background: dark ? '#202839' : '#fff', /*height: autoheight() - 180 + 'px'*/}}
                            ...
                            <div>
                                ...
                                <Row gutter={{md: 8, lg: 24, xl: 48}}>
                                    <Col md={8} sm={24}>
                                        ...
                                        <div className={styles.Indextail} style={{paddingLeft: '84px'}}>
                                            <a onClick={() => this.person(itemDetails)}
                                ...
                                <Row gutter={{md: 8, lg: 24, xl: 48}}>
                                    <Col md={8} sm={24}>
                                        ...
                                        <div className={styles.Indextail}
                                             style={{paddingLeft: 70}}>{itemDetails && itemDetails.wply ? itemDetails.wply : ''}</div>
                                    </Col>
                                    {/*<Col md={8} sm={24}>*/}
