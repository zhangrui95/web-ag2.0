...
@connect(({ UnItemData, loading, common, MySuperviseData }) => ({
  UnItemData, loading, common, MySuperviseData,
...
export default class Index extends PureComponent {
  ...
  renderForm() {
    ...
    return (
      <Form onSubmit={this.itemSearch} style={{height: this.state.searchHeight ? 'auto' : '59px',position:'relative'}}>
          ...
          <Col {...colLayout}>
            <FormItem label="问题类型" {...formItemLayout}>
              {getFieldDecorator('wtlx', {
                ...
                <Select placeholder="请选择问题类型" style={{ width: '100%' }} getPopupContainer={() => document.getElementById('sawpgjtableListForm')}>
          ...
          <Col {...colLayout}>
            <FormItem label="物品种类" {...formItemLayout}>
              {getFieldDecorator('wpzl', {
                ...
                <Select placeholder="请选择物品种类" style={{ width: '100%' }} getPopupContainer={() => document.getElementById('sawpgjtableListForm')}>
                  <Option value="">全部</Option>
                  {itemsTypesOptions}
                </Select>,
              )}
          ...
          <Col {...colLayout}>
            <FormItem label="物品状态" {...formItemLayout}>
              {getFieldDecorator('wpzt', {
                ...
                <Select placeholder="请选择物品状态" style={{ width: '100%' }} getPopupContainer={() => document.getElementById('sawpgjtableListForm')}>
                  <Option value="">全部</Option>
          ...
          <Col {...colLayout}>
            <FormItem label="产生方式" {...formItemLayout}>
              {getFieldDecorator('csfs', {
                ...
                <Select placeholder="请选择产生方式" style={{ width: '100%' }} onChange={this.getCsfs} getPopupContainer={() => document.getElementById('sawpgjtableListForm')}>
                  <Option value="">全部</Option>
