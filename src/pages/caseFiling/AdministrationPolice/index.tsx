...
// 获取督办状态
          ...
          <Col {...colLayout}>
            <FormItem label="问题类型" {...formItemLayout}>
              {getFieldDecorator('wtlx', {
                ...
                <Select placeholder="请选择" style={{ width: '100%' }} getPopupContainer={() => document.getElementById('slaxzajgjtableListForm')}>
            ...
            <FormItem label="受理单位" {...formItemLayout}>
              {getFieldDecorator('sldw', {
                ...
                <TreeSelect
                  ...
                  getPopupContainer={() => document.getElementById('slaxzajgjtableListForm')}
                >
            ...
            <FormItem label="告警时间" {...formItemLayout}>
              {getFieldDecorator('gjsj', {
                ...
                <RangePicker
                  ...
                  style={{ width: '100%' }}
                  getCalendarContainer={() => document.getElementById('slaxzajgjtableListForm')}
                />,
              )}
            </FormItem>
          </Col>
          ...
          <Col {...colLayout}>
            <FormItem label="产生方式" {...formItemLayout}>
              {getFieldDecorator('csfs', {
                ...
                <Select placeholder="请选择" style={{ width: '100%' }}  onChange={this.getCsfs} getPopupContainer={() => document.getElementById('slaxzajgjtableListForm')}>
                  <Option value="">全部</Option>
  ...
  render() {
    ...
    return (
      <div className={this.props.location.query && this.props.location.query.id ? styles.onlyDetail : ''} id='slaxzajgjtableListForm'>
