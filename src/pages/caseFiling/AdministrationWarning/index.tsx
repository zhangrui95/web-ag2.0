...
export default class Index extends PureComponent {
  state = {
    yjjb: '',
    formValues: { yj_type: 'xzaj', ssmk: '1' }, // 查询条件
    activeKey: '0',
    arrayDetail: [],
    allPolice: [],
    jzlb: '',
  ...
  componentDidMount() {
    ...
    this.getDossier({ pd: { yj_type: 'xzaj', ssmk: '1' } });
  ...
  handleFormReset = () => {
    ...
    this.setState({
      formValues: { yj_type: 'xzaj', ssmk: '1' },
    });
    this.getDossier({ pd: { yj_type: 'xzaj', ssmk: '1' } });
  };
  // 导出
  ...
  details = (record) => {
    ...
    //       yjType="yj"
    //       getCase={() => this.getDossier({ pd: { yj_type: 'xzaj', ssmk: '1' } })}
    //       yjid={record.id}
    //     />
    //   </div>
    // );
  ...
  render() {
    ...
    return (
      <div>
            <div className={styles.tableListForm} id='slaxzajyj'>
                  ...
                  <Col {...colLayout}>
                    <FormItem label="预警类型" {...formItemLayout}>
                      {getFieldDecorator('yjlx', {
                        ...
                        <Select placeholder="请选择" style={{ width: '100%' }} getPopupContainer={() => document.getElementById('slaxzajyj')}>
                    ...
                    <FormItem label="预警时间" {...formItemLayout}>
                      {getFieldDecorator('yjsj')(
                        <RangePicker
                          ...
                          style={{ width: '100%' }}
                          getCalendarContainer={() => document.getElementById('slaxzajyj')}
                        />,
                      )}
                    </FormItem>
                  </Col>
