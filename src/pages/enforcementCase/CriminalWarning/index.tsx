...
export default class Index extends PureComponent {
    state = {
        yjjb: '',
        formValues: {yj_type: 'xsaj', ssmk: '2'}, // 查询条件
        activeKey: '0',
        arrayDetail: [],
        allPolice: [],
        jzlb: '',
    ...
    componentDidMount() {
        ...
        this.getDossier({pd: {yj_type: 'xsaj', ssmk: '2'}});
    ...
    handleFormReset = () => {
        ...
        this.setState({
            formValues: {yj_type: 'xsaj', ssmk: '2'},
        });
        this.getDossier({pd: {yj_type: 'xsaj', ssmk: '2'}});
    };
    // 导出
    ...
    details = record => {
        ...
        //       yjType="yj"
        //       getCase={() => this.getDossier({ pd: { yj_type: 'xsaj', ssmk: '2' } })}
        //       yjid={record.id}
        //     />
        //   </div>
        // );
    ...
    render() {
        ...
        //           this.state.caseDetails.ajmc &&
        //           this.state.caseDetails.ajmc.length > 20
        //             ? this.state.caseDetails.ajmc
        //             : null
        //         }
        //       >
        //         {this.state.caseDetails && this.state.caseDetails.ajmc
        //           ? this.state.caseDetails.ajmc.length > 20
        //             ? this.state.caseDetails.ajmc.substring(0, 20) + '...'
        //             : this.state.caseDetails.ajmc
        //           : ''}
        //       </Tooltip>
        //     </Col>
        ...
        //         title={
        //           this.state.caseDetails &&
        //           this.state.caseDetails.bardwmc &&
        //           this.state.caseDetails.bardwmc.length > 20
        //             ? this.state.caseDetails.bardwmc
        //             : null
        //         }
        //       >
        //         {this.state.caseDetails && this.state.caseDetails.bardwmc
        //           ? this.state.caseDetails.bardwmc.length > 20
        //             ? this.state.caseDetails.bardwmc.substring(0, 20) + '...'
        //             : this.state.caseDetails.bardwmc
        //           : ''}
        //       </Tooltip>
        //     </Col>
        //     <Col span={12}>
        //       案件状态：
        //       {this.state.caseDetails && this.state.caseDetails.schj ? this.state.caseDetails.schj : ''}
        //     </Col>
        //     <Col span={12}>
        //       办案民警：
        //       {this.state.caseDetails && this.state.caseDetails.sabar
        //         ? this.state.caseDetails.sabar
        //         : ''}
        //     </Col>
        //   </Row>
        // );
        ...
        return (
            <div>
                <div className={styles.tableListForm} id="zfbaxsajyjtableListForm">
                    <Form
                                ...
                                <FormItem label="预警类型" {...formItemLayout}>
                                    {getFieldDecorator('yjlx', {
                                        ...
                                        <Select
                                            placeholder="请选择预警类型"
                                            style={{width: '100%'}}
                                            getPopupContainer={() => document.getElementById('zfbaxsajyjtableListForm')}
                                        >
                                            <Option value="">全部</Option>
                                            {XsyjType.map(event => {
                                                return <Option value={event.code}>{event.name}</Option>;
                                            })}
                                            <Option value="5025406">重大级别刑事未立案</Option>
                                            <Option value="5025407">刑事未立案</Option>
                                        </Select>,
                                    )}
                                </FormItem>
                            </Col>
                                    ...
                                    {getFieldDecorator('yjsj')(
                                        <RangePicker
                                            ...
                                            getCalendarContainer={() =>
                                                document.getElementById('zfbaxsajyjtableListForm')
                                            }
                                        />,
                                    )}
                                </FormItem>
