/*
* Enforcement/index.js 执法办案刑事案件告警数据
* author：jhm
* 20180605
* */
...
import { Row, Col, Form, Select, TreeSelect, Input, Button, DatePicker, Radio, Tabs, message, Card, Icon } from 'antd';
...
@connect(({ UnCaseData, loading, common, MySuperviseData }) => ({
  UnCaseData, loading, common, MySuperviseData,
...
// 获取案件状态字典
  ...
  renderForm() {
    ...
    return (
      <Card className={stylescommon.listPageWrap} style={{border:'0px solid #ccc'}}>
            ...
            <Col {...colLayout}>
              <FormItem label="问题类型" {...formItemLayout}>
                {getFieldDecorator('wtlx', {
                  ...
                  <Select placeholder="请选择问题类型" style={{ width: '100%' }} getPopupContainer={() => document.getElementById('zfbaxsajgjtableListForm')}>
            ...
            <Col {...colLayout}>
              <FormItem label="案件状态" {...formItemLayout}>
                {getFieldDecorator('ajzt', {
                  ...
                  <Select placeholder="请选择案件状态" style={{ width: '100%' }} getPopupContainer={() => document.getElementById('zfbaxsajgjtableListForm')}>
                    <Option value="">全部</Option>
                    {CaseStatusOption}
                  </Select>,
                )}
              ...
              <FormItem label="告警时间" {...formItemLayout}>
                {getFieldDecorator('gjsj', {
                  ...
                  <RangePicker
                    ...
                    style={{ width: '100%' }}
                    getCalendarContainer={() => document.getElementById('zfbaxsajgjtableListForm')}
                  />,
                )}
              </FormItem>
            </Col>
            ...
            <Col {...colLayout}>
              <FormItem label="产生方式" {...formItemLayout}>
                {getFieldDecorator('csfs', {
                  ...
                  <Select placeholder="请选择产生方式" style={{ width: '100%' }} onChange={this.getCsfs} getPopupContainer={() => document.getElementById('zfbaxsajgjtableListForm')}>
                    <Option value="">全部</Option>
      ...
      <div className={this.props.location.query && this.props.location.query.id ? styles.onlyDetail : ''}>
            <div className={styles.listPageWrap}>
              ...
              <div style={showDataView ? { display: 'none' } : { display: 'block' }}>
                <div className={styles.tableListForm} style={{ position: 'relative' }} id='zfbaxsajgjtableListForm'>
                  {this.renderForm()}
                </div>
