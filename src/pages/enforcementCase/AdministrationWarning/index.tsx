...
export default class Index extends PureComponent {
  state = {
    yjjb: '',
    formValues: { yj_type: 'xzaj', ssmk: '2' }, // 查询条件
    activeKey: '0',
    arrayDetail: [],
    allPolice: [],
    jzlb: '',
  ...
  componentDidMount() {
    ...
    this.getDossier({ currentPage: 1, pd: { yj_type: 'xzaj', ssmk: '2' }, showCount: 10 });
  ...
  handleFormReset = () => {
    ...
    this.setState({
      formValues: { yj_type: 'xzaj', ssmk: '2' },
    });
    this.getDossier({ pd: { yj_type: 'xzaj', ssmk: '2' } });
  };
  // 导出
  exportData = () => {
  ...
  details = (record) => {
    ...
    //       getCase={() => this.getDossier({
    //         currentPage: 1,
    //         pd: { yj_type: 'xzaj', ssmk: '2' },
    //         showCount: 10,
    //       })}
    //       yjid={record.id}
    //     />
  ...
  render() {
    ...
    const paginationProps = {
      ...
      showTotal: (total, range) =>
        <span
          className={styles.listPagination}>{`共 ${page ? page.currentPage : 1} / ${page ? page.totalPage : 1} 页， ${page ? page.totalResult : 0} 条记录 `}</span>,
    };
    return (
      <div>
                  ...
                  <Col {...colLayout}>
                    <FormItem label="预警类型" {...formItemLayout}>
                      {getFieldDecorator('yjlx', {
                        ...
                        <Select placeholder="请选择" style={{ width: '100%' }} getPopupContainer={() => document.getElementById('zfbaxzajyjtableListForm')}>
                    ...
                    <FormItem label="预警时间" {...formItemLayout}>
                      {getFieldDecorator('yjsj')(
                        <RangePicker
                          ...
                          style={{ width: '100%' }}
                          getCalendarContainer={() => document.getElementById('zfbaxzajyjtableListForm')}
                        />,
                      )}
                    </FormItem>
                  </Col>
