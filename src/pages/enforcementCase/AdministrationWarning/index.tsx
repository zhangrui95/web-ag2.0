    ...
    render() {
        ...
        const paginationProps = {
            ...
            showTotal: (total, range) => (
                <span className={styles.listPagination}>{`共 ${page ? page.currentPage : 1} / ${
                                ...
                                <FormItem label="预警类型" {...formItemLayout}>
                                    {getFieldDecorator('yjlx', {
                                        ...
                                        <Select
                                            placeholder="请选择"
                                            style={{width: '100%'}}
                                            getPopupContainer={() => document.getElementById('zfbaxzajyjtableListForm')}
                                        >
                                    ...
                                    {getFieldDecorator('yjsj')(
                                        <RangePicker
                                            ...
                                            getCalendarContainer={() =>
                                                document.getElementById('zfbaxzajyjtableListForm')
                                            }
                                        />,
                                    )}
                                </FormItem>
