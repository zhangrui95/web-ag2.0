...
import { Row, Col, Form, Select, TreeSelect, Input, Button, DatePicker, Tabs, Radio, message, Cascader, Icon, Card } from 'antd';
            ...
            <Col {...colLayout}>
              <FormItem label="接警来源" {...formItemLayout}>
                {getFieldDecorator('jjly', {
                  ...
                  <Select placeholder="请选择接警来源" style={{ width: '100%' }} getPopupContainer={() => document.getElementById('tableListForm')}>
            ...
            <Col {...colLayout}>
              <FormItem label="处理状态" {...formItemLayout}>
                {getFieldDecorator('clzt', {})(
                  <Select placeholder="请选择处理状态" style={{ width: '100%' }} getPopupContainer={() => document.getElementById('tableListForm')}>
                    <Option value="">全部</Option>
