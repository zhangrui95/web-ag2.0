...
@connect(({ UnPoliceData, loading, MySuperviseData }) => ({
    UnPoliceData, loading, MySuperviseData,  // loading: loading.models.alarmManagement,
}))
@Form.create()
export default class unpoliceDetail extends PureComponent {
                ...
                <div className={styles.message}>
                    <Row gutter={rowLayout}>
                        <Col md={6} sm={24}>
                            ...
                            <div
                                className={liststyles.Indextail}>{policeDetails && policeDetails.jjly_mc ? policeDetails.jjly_mc : ''}</div>
                        </Col>
                        <Col md={6} sm={24}>
                        ...
                        <Col md={6} sm={24}>
                            ...
                            <div className={liststyles.Indextail}
                                 style={{ paddingLeft: '70px' }}>{policeDetails && policeDetails.jjr ? policeDetails.jjr.split(',')[policeDetails.jjr.split(',').length - 1] : ''}</div>
                        </Col>
                        <Col md={6} sm={24}>
                            <div className={liststyles.Indexfrom}>管辖单位：</div>
                            <div
                                className={liststyles.Indextail}>{policeDetails && policeDetails.jjdw ? policeDetails.jjdw.split(',')[policeDetails.jjdw.split(',').length - 1] : ''}</div>
                        </Col>
                    </Row>
                    <Row gutter={rowLayout}>
                        <Col md={6} sm={24}>
                            ...
                            <div className={liststyles.Indextail}
                                 style={{ paddingLeft: '70px' }}>{policeDetails && policeDetails.bar ? policeDetails.bar : ''}</div>
                        </Col>
                        <Col md={6} sm={24}>
                            <div className={liststyles.Indexfrom}>报案人联系方式：</div>
                            <div className={liststyles.Indextail}
                                 style={{ paddingLeft: '126px' }}>{policeDetails && policeDetails.bar_lxfs ? policeDetails.bar_lxfs : ''}</div>
                        </Col>
                    </Row>
                    <Row gutter={rowLayout}>
                        <Col md={24} sm={24}>
                            ...
                            <div
                                className={liststyles.Indextail}>{policeDetails && policeDetails.jjnr ? policeDetails.jjnr : ''}</div>
                        </Col>
                    </Row>
                </div>
                ...
                <div className={styles.message}>
                    <Row gutter={rowLayout}>
                        <Col md={6} sm={24}>
                            ...
                            <div
                                className={liststyles.Indextail}>{policeDetails && policeDetails.cjdw ? policeDetails.cjdw : ''}</div>
                        </Col>
                        <Col md={6} sm={24}>
                    ...
                    <Row gutter={rowLayout}>
                        <Col md={24} sm={24}>
                            ...
                            <div
                                className={liststyles.Indextail}>{policeDetails && policeDetails.czjg_mc ? policeDetails.czjg_mc : ''}</div>
                        </Col>
                    </Row>
                    <Row gutter={rowLayout}>
                        <Col md={24} sm={24}>
                            ...
                            <div
                                className={liststyles.Indextail}>{policeDetails && policeDetails.cjqk ? policeDetails.cjqk : ''}</div>
                        </Col>
                    </Row>
                    <Row gutter={rowLayout}>
                        <Col md={24} sm={24}>
                            ...
                            <div
                                className={liststyles.Indextail}>{policeDetails && policeDetails.cj_clyj ? policeDetails.cj_clyj : ''}</div>
                        </Col>
                    </Row>
                </div>
                {policeDetails && (policeDetails.ajbh || policeDetails.barxm || policeDetails.ajmc || policeDetails.badw_mc || policeDetails.ajxz_mc || policeDetails.jyaq) ?
                    <div>
                        ...
                        <div className={styles.message}>
                            <Row gutter={rowLayout}>
                                ...
                                <Col md={6} sm={24}>
                                    ...
                                    <div
                                        className={liststyles.Indextail}>{policeDetails && policeDetails.ajmc ? policeDetails.ajmc : ''}</div>
                                </Col>
                                <Col md={6} sm={24}>
                                    <div className={liststyles.Indexfrom}>案件状态：</div>
                                    <div
                                        className={liststyles.Indextail}>{policeDetails && policeDetails.ajzt ? policeDetails.ajzt : ''}</div>
                                </Col>
                                <Col md={6} sm={24}>
                                    <div className={liststyles.Indexfrom}>案发时段：</div>
                                    <div
                                        className={liststyles.Indextail}>{policeDetails && policeDetails.fasjsx && policeDetails.fasjxx ? policeDetails.fasjsx + '~' + policeDetails.fasjxx : ''}</div>
                                </Col>
                            </Row>
                            <Row gutter={rowLayout}>
                                <Col md={6} sm={24}>
                                    ...
                                    <div
                                        className={liststyles.Indextail}>{policeDetails && policeDetails.badw_mc ? policeDetails.badw_mc : ''}</div>
                                </Col>
                                <Col md={6} sm={24}>
                                    <div className={liststyles.Indexfrom}>办案人：</div>
                                    <div className={liststyles.Indextail}
                                         style={{ paddingLeft: '70px' }}>{policeDetails && policeDetails.barxm ? policeDetails.barxm : ''}</div>
                                </Col>
                                <Col md={6} sm={24}>
                                    <div className={liststyles.Indexfrom}>案发地点：</div>
                                    <div
                                        className={liststyles.Indextail}>{policeDetails && policeDetails.afdd ? policeDetails.afdd : ''}</div>
                                </Col>
                            </Row>
                            <Row gutter={rowLayout}>
                                <Col md={24} sm={24}>
                                    ...
                                    <div
                                        className={liststyles.Indextail}>{policeDetails && policeDetails.jyaq ? policeDetails.jyaq : ''}</div>
                                </Col>
                            </Row>
                          {
    ...
    render() {
        const { policeDetails, superviseVisibleModal, history, RestDbrz, unCaseDetailData, reformModal, seeDetail, Isdetail, NowDbrz, feedbackVisibleModal } = this.state;
        return (
            <div>
                <div>
                    {this.Topdetail()}
