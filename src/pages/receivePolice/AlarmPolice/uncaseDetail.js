...
@connect(({ UnCaseData, loading, MySuperviseData, AllDetail }) => ({
    UnCaseData, loading, MySuperviseData, AllDetail,
...
export default class uncaseDetail extends PureComponent {
                        ...
                        <span style={{ float: 'right', margin: '12px 16px 12px 0' }}>
                            {
                                unCaseDetailData.zt === '待督办' && isDb ? (
                                    <Button type="primary" style={{ marginLeft: 8 }} loading={this.state.loading1}
                                            onClick={() => this.onceSupervise(true, unCaseDetailData)}>督办</Button>
                                ) : null
                            }
                            {
                                unCaseDetailData && (unCaseDetailData.dbid === '' || (unCaseDetailData.dbList && unCaseDetailData.dbList.length > 0 && unCaseDetailData.dbList[unCaseDetailData.dbList.length - 1].fkzt !== '1')) && isDb ? (
                                    <Button
                                        type="primary"
                                        style={{ marginLeft: 8 }}
                            ...
                            }
                            {
                                this.props.isDd && this.props.record && this.props.record.is_sqdd === '0' ?
                                    <Button type="primary" style={{ marginLeft: 8 }}
                                            onClick={() => this.props.saveDispatch(this.props.record)}>调度</Button> : ''
                            }
                        </span>
                    </Col>
                </Row>
                    ...
                    <List.Item>
                        <div className={styles.colsImg}>
                            <div className={styles.sawpImg}>
                                <img width='70' height='70' src={item && item.url ? item.url : 'images/nophoto.png'}/>
                            </div>
    ...
    renderDetail(unCaseDetailData) {
        const { UnCaseData: { loading } } = this.props;
        ...
        const JqColumns = [
            {
                ...
                dataIndex: 'jjly_mc',
                render: (text) => {
                    return <Ellipsis length={10} tooltip>{text}</Ellipsis>;
                },
            },
            {
                title: '接警时间',
                ...
                <div className={styles.message} style={{ padding: '24px 0' }}>
                    <Row gutter={rowLayout}>
                        <Col md={6} sm={24}>
                            ...
                            <div
                                className={liststyles.Indextail}>{unCaseDetailData && unCaseDetailData.ajbh ? unCaseDetailData.ajbh : ''}</div>
                        </Col>
                        <Col md={6} sm={24}>
                            <div className={liststyles.Indexfrom}>案件名称：</div>
                            <div
                                className={liststyles.Indextail}>{unCaseDetailData && unCaseDetailData.ajmc ? unCaseDetailData.ajmc : ''}</div>
                        </Col>
                        <Col md={6} sm={24}>
                            <div className={liststyles.Indexfrom}>案件类别：</div>
                            <div
                                className={liststyles.Indextail}>{unCaseDetailData && unCaseDetailData.ajlbmc ? unCaseDetailData.ajlbmc : ''}</div>
                        </Col>
                    </Row>
                    <Row gutter={rowLayout}>
                        <Col md={6} sm={24}>
                            ...
                            <div
                                className={liststyles.Indextail}>{unCaseDetailData && unCaseDetailData.fasjsx && unCaseDetailData.fasjxx ? unCaseDetailData.fasjsx + '~' + unCaseDetailData.fasjxx : ''}</div>
                        </Col>
                        {/*{*/}
                        ...
                        <Col md={6} sm={24}>
                            ...
                            <div
                                className={liststyles.Indextail}>{unCaseDetailData && unCaseDetailData.afdd ? unCaseDetailData.afdd : ''}</div>
                        </Col>
                    </Row>
                    <Row gutter={rowLayout}>
                        <Col md={24} sm={24}>
                            ...
                            <div
                                className={liststyles.Indextail}>{unCaseDetailData && unCaseDetailData.jyaq ? unCaseDetailData.jyaq : ''}</div>
                        </Col>
                    </Row>
                    {unCaseDetailData && unCaseDetailData.ajzt ?
                        <Card title={'案件流程'} style={{ margin: '0 12px' }}>
                            <CaseModalStep
                                caseDetails={unCaseDetailData}
                            />
                        </Card>
                        :
                        ''
    ...
    render() {
        const { superviseVisibleModal, history, RestDbrz, unCaseDetailData, reformModal, seeDetail, Isdetail, NowDbrz, feedbackVisibleModal } = this.state;
        return (
            <div>
                <div>
                    {this.Topdetail()}
                ...
                <div>
                    {this.renderDetail(unCaseDetailData)}
                </div>
