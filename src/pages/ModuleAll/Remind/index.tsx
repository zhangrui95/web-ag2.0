...
import { Modal, Form, Input, Select, message, button, Card, Button } from 'antd';
        ...
        <Card className={styles.standardTable}  id='RemindModule'>
          ...
          <Form>
            ...
            <FormItem {...formItemLayout} label="提醒建议">
              {getFieldDecorator('shareSuggest')(<TextArea rows={4} style={{resize:'none'}} placeholder='请输入不超过500字'/>)}
            </FormItem>
          </Form>
        </Card>
        <Card>
