...
export default class Home2 extends PureComponent {
    ...
    getNums = () => {
        let data_ks1 = moment(new Date()).add(-1, 'days').format('YYYY-MM-DD 08:00:00');
        let data_js1 = moment(new Date()).format('YYYY-MM-DD 08:00:00');
        let data_ks2 = moment().subtract('days', 31).format('YYYY-MM-DD 00:00:00');
        let data_js2 = moment().subtract('days', 1).format('YYYY-MM-DD 23:59:59');
        let data_ks3 = moment().subtract('days', 90).format('YYYY-MM-DD 00:00:00');
        let data_js3 = moment().subtract('days', 1).format('YYYY-MM-DD 23:59:59');
        this.props.dispatch({
            type: 'Home/getNums',
            payload: {
                rq_jssj: data_js1,
                            ...
                            <Row gutter={16}>
                                <Col span={8} xl={{ span: 6 }} xxl={{ span: 6 }}>
                                    <Row className={styles.gutterBox2}>
                                        <Col span={9} xl={{ span: 9 }} xxl={{ span: 10, offset: 1 }}
                                             className={styles.iconLeft2}>
                                            日清零
                                        </Col>
                                        <Link className={styles.whiteWord}
                                ...
                                <Col span={16} xl={{ span: 9 }} xxl={{ span: 9 }}>
                                    <Row className={styles.gutterBox2} style={{ background: '#ff9934' }}>
                                        <Col span={6} xl={{ span: 6 }} xxl={{ span: 6, offset: 1 }}
                                             className={styles.iconLeft2} style={{ borderRight: '1px solid #cc6b0b' }}>
                                            月清仓
                                        </Col>
                                        <Link className={styles.whiteWord}
                                ...
                                <Col span={24} xl={{ span: 9 }} xxl={{ span: 9 }}>
                                    <Row className={styles.gutterBox2} style={{ background: '#2095ff' }}>
                                        <Col span={6} xl={{ span: 6 }} xxl={{ span: 6, offset: 1 }}
                                             className={styles.iconLeft2} style={{ borderRight: '1px solid #155d9e' }}>
                                            季清底
                                        </Col>
                                        <Link className={styles.whiteWord}
                    ...
                    <div className={styles.rightList}>
                        {
                            this.state.headerList.map((item, i) => {
                                return <div className={styles.rightBoxList} onClick={() => this.changeTable(i)}>
