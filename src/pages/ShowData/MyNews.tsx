            ...
            <div>
                ...
                <div className={styles.myNewsMessage} style={{backgroundColor: dark ? '#202839' : '#fff'}}>
                    <Row gutter={rowLayout} style={{marginBottom: 24}}>
                        ...
                        <Col
                            span={query && query.record && query.record.name && query.record.name.length > 16 ? 16 : 8}>
                    ...
                    <Row gutter={rowLayout} style={{marginBottom: 24}}>
                        <Col
                            span={8}>责任人：{query && query.record && query.record.zrrName ? query.record.zrrName : ''}</Col>
                        <Col span={8}>反馈时间：{query && query.record && query.record.time ? query.record.time : ''}</Col>
                        <Col
                            span={8}>问题类型：{query && query.record && query.record.wtlxMc ? query.record.wtlxMc : ''}</Col>
                    </Row>
                    <Row gutter={rowLayout} style={{marginBottom: 24}}>
                        <Col span={24}>
