    ...
    search() {
        ...
        return (
            <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
                <Col md={12} sm={24}>
                    <StatisticsDateSelect setSelectDateValue={this.setSelectDateValue}
                                          selectDateValue={this.state.selectDateValue} emptyData={this.emptyData}/>
                </Col>
                <Col md={12} sm={24}>
                    <div className={stylescommon.buttonArea}>
                        <Button type='submit' icon={"download"} onClick={() => this.exportData()}>导出</Button>
                    </div>
                </Col>
            </Row>
        );
                ...
                <Card className={stylescommon.cardArea}>
                    <div>
                        <Table
                            ...
                            scroll={{ x: this.state.data && this.state.data.list && this.state.data.list.length > 0 ? '350%' : '100%' }}
