...
import { Row, Col, Form, Button, DatePicker, Tabs, Radio, message, Table, Card, Tooltip, TreeSelect } from 'antd';
...
export default class RYCZTZ extends PureComponent {
    ...
    cJTreeSelectChange = (value,label,extra) => {
      ...
      if(extra&&extra.triggerNode&&extra.triggerNode.props&&extra.triggerNode.props.children){
        extra.triggerNode.props.children.map((item)=>(
          newNum.push("'"+item.props.value+"'")
        ))
      }
      else{
        newNum.push("'"+value+"'")
