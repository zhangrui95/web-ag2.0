...
@Form.create()
export default class SLAQKJDGLDJB extends PureComponent {
    state = {
        selectDateValue: {
        ...
        return (
            <div>
                <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
                    <Col md={12} sm={24}>
                        <StatisticsDateSelect placeholder="请选择受案时间" setSelectDateValue={this.setSelectDateValue}
                                              selectDateValue={this.state.selectDateValue} emptyData={this.emptyData}/>
                    </Col>
                    <Col md={12} sm={24}>
                ...
                <Card className={stylescommon.cardArea}>
                    <div>
                        <Table
                            ...
                            scroll={{ x: this.state.data && this.state.data.list && this.state.data.list.length > 0 ? '200%' : '100%' }}
                        />
                    </div>
                </Card>
            </div>
